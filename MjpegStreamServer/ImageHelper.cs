#region License
// /////////////////////////////////////////////////////////////////////////////
// 创建日期:     2019年10月24日11:57
// 修改日期:     2019年10月24日11:57
// 文件名称:     ImageHelper.cs
// 创建作者:     LYJ
// 类 描 述 :  
// /////////////////////////////////////////////////////////////////////////////
...
namespace MjpegStreamServer
{
    public class ImageHelper
    {
        ...
        {
            Rectangle tScreenRect = new Rectangle(captureRectangle.X, captureRectangle.Y, captureRectangle.Width,captureRectangle.Height);
            Bitmap tSrcBmp = new Bitmap(tScreenRect.Width, tScreenRect.Height); // 用于屏幕原始图片保存

            Graphics gp = Graphics.FromImage(tSrcBmp);
            gp.CopyFromScreen(tScreenRect.X, tScreenRect.Y, 0, 0, tScreenRect.Size);
